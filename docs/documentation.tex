...
\centering
\begin{tikzpicture}[
    node distance = 0.82cm and 4.4cm,
  ...
  \draw[arr] (fbcast.south) -| (pmerge.east);
  \draw[arr] (funk.south)   -| (pmerge.east);
  \draw[arr] (flip.south)   -| (pmerge.east);
...
\begin{tikzpicture}[node distance=0.9cm and 3.2cm]
  ...
  \draw[arr] (inacl)  -- node[lbl,above]{deny}   (drop1);
  \draw[arr] (outacl) -- node[lbl,above]{deny}   (drop2);
